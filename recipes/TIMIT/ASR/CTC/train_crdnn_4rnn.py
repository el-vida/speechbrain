#!/usr/bin/env python3
"""Recipe for training a phoneme recognizer on TIMIT with CRDNN + 4-layer vanilla RNN.
...
> python train_crdnn_4rnn.py hparams/train_crdnn_4rnn.yaml --data_folder /path/to/TIMIT
 ...
 * Modified for CRDNN + 4-layer vanilla RNN by Elija Vida 2026
"""
