#!/usr/bin/env python3
"""Recipe for training a phoneme recognizer on TIMIT with CRDNN + 4-layer LSTM.
...
> python train_crdnn_4lstm.py hparams/train_crdnn_4lstm.yaml --data_folder /path/to/TIMIT
 ...
 * Modified for CRDNN + 4-layer LSTM by Elija Vida 2026
"""
